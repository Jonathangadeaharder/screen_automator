...
from src.action_executor import ActionExecutor, create_click_action, create_type_text_action, create_wait_action
...
class TestCoreComprehensive:
    ...
    def test_screen_automator_init(self, mock_rule_mgr, mock_executor, mock_detector, mock_listener):
    ...
    @patch('src.automator.ActionExecutor')
    @patch('src.automator.RuleManager')
    def test_screen_automator_monitoring(self, mock_rule_mgr, mock_executor, mock_detector, mock_listener):
